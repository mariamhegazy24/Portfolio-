...
export default function RecentWork() {
  ...
  const Data = [
    { 
      title: "Tech Blog APP", 
      description: "A modern blogging platform where users can browse posts, create new articles, edit, delete, and publish/unpublish content. Built with React, Tailwind CSS, and json-server authentication, the app offers smooth performance and a clean UI.", 
      photo: "/tech1.png", 
    ...
    { 
      ...
      description: "A home-made food delivery app that connects chefs with customers looking for fresh, authentic meals. The app is built using React, Redux Toolkit, and Chakra UI, providing an easy browsing experience, clear meal details, and smooth interaction between chefs and users", 
      photo: "/tablya2.png", 
